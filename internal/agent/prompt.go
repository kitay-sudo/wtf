...
4. **ПАРАЛЛЕЛЬНОСТЬ — это критично.** За один раунд возвращай СРАЗУ массив
   из 3-7 независимых tool_calls (run_command). Не шли по одной команде.
   Каждый раунд = деньги и время юзера.
...
4. **PARALLELISM IS CRITICAL.** In a single round, return an ARRAY of 3-7
